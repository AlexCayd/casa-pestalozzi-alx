...
comprobar(str_contains($formulario, 'data-role-nip-section'), 'La edición no expone el estado compacto de NIP.');
comprobar(str_contains($formulario, 'data-has-persisted-nip'), 'La edición no entrega el estado persistido al frontend.');
comprobar(str_contains($formulario, 'admin-users-nip-line'), 'El NIP no está integrado como línea del formulario.');
comprobar(!str_contains($formulario, 'Acceso de piso'), 'La línea de NIP conserva el bloque de acceso de piso.');
comprobar(str_contains($formulario, 'Se generará un NIP automáticamente al guardar.'), 'Falta la indicación de generación al guardar.');
comprobar(str_contains($estilos, 'admin-users-nip-line'), 'Faltan estilos para la línea compacta de NIP.');
comprobar(!str_contains($estilos, 'admin-users-access-inline'), 'La interfaz conserva la antigua tarjeta de acceso.');
