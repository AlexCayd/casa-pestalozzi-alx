  ...
  <div class="mapa-shell">
    ...
    <header class="mapa-header">
      ...
      <div class="mapa-header-controls">
        ...
        <form method="POST" action="/logout" class="mapa-logout-form">
          <button class="mapa-logout" type="submit" title="Cerrar sesión" aria-label="Cerrar sesión">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><path d="m16 17 5-5-5-5"/><path d="M21 12H9"/>
            </svg>
            <span><?php echo htmlspecialchars($_SESSION['nombre'] ?? 'Salir', ENT_QUOTES, 'UTF-8'); ?></span>
          </button>
        </form>
      </div>
    </header>
